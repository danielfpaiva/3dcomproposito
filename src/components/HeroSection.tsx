...
const stats = [
  { icon: Users, value: "1,247", label: "Contributors Joined" },
  { icon: Printer, value: "3,892", label: "Parts Printed" },
  { icon: Heart, value: "142", label: "Wheelchairs Completed" },
];
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-accent/10 border border-accent/20 mb-6">
            ...
            <span className="text-sm font-medium text-emerald-light">Live Mission — 48 printers active now</span>
          </div>

          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-primary-foreground leading-tight mb-6">
            Transform scattered prints into
            <br />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            ...
            <Button
              variant="outline"
              size="lg"
              className="border-primary-foreground/20 text-primary-foreground/80 hover:bg-primary-foreground/5 hover:text-primary-foreground font-medium text-base px-8 py-6 rounded-xl bg-transparent"
            >
              See How It Works
            </Button>
          </div>
        ...
        >
          {stats.map((stat, i) => (
            ...
            >
              ...
              <span className="text-3xl font-black text-primary-foreground animate-count-up">
                {stat.value}
              </span>
